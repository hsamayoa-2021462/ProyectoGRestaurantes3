...
export default function AuthStack({ initialRoute, initialParams }) {
    return (
        <Stack.Navigator
            ...
            <Stack.Screen name="VerifyEmail" component={VerifyEmailScreen} initialParams={initialRoute === 'VerifyEmail' ? initialParams : undefined} />
            <Stack.Screen name="ForgotPassword" component={ForgotPasswordScreen} />
            <Stack.Screen name="ResetPassword" component={ResetPasswordScreen} initialParams={initialRoute === 'ResetPassword' ? initialParams : undefined} />
        </Stack.Navigator>
    );
}