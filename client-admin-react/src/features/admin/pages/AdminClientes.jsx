...
export default function AdminClientes() {
    ...
    return (
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        .sc{background:var(--glass-bg);border:1px solid var(--glass-bd);border-radius:var(--radius-card);padding:22px;position:relative;overflow:hidden;transition:border-color .25s,transform .2s}
        ...
        .sc-val{font-family:'Cormorant Garamond',serif;font-size:32px;font-weight:500;line-height:1;margin-bottom:4px}
        .sc-lbl{font-size:11.5px;color:var(--text-muted)}
        .tcard{background:var(--glass-bg);border:1px solid var(--glass-bd);border-radius:var(--radius-card);overflow:hidden}
        .thead-row{display:flex;align-items:center;justify-content:space-between;padding:20px 24px;border-bottom:1px solid var(--glass-bd);gap:12px;flex-wrap:wrap}
        .thead-title{font-family:'Cormorant Garamond',serif;font-size:17px;font-weight:500;letter-spacing:.3px}
        ...
        .fbtn{padding:6px 14px;border-radius:7px;background:var(--glass-bg);border:1px solid var(--glass-bd);color:var(--text-muted);cursor:pointer;font-size:12px;font-family:'Outfit',sans-serif;transition:all .2s;white-space:nowrap}
        .fbtn:hover{color:var(--text)}
        .fbtn.act{background:var(--gold-dim);border-color:rgba(201,168,76,.3);color:var(--gold-lt)}
        .sbox{display:flex;align-items:center;gap:8px;background:rgba(255,255,255,.04);border:1px solid var(--glass-bd);border-radius:10px;padding:7px 12px}
        .sbox input{background:none;border:none;outline:none;color:var(--text);font-family:'Outfit',sans-serif;font-size:13px;width:200px}
        .sbox input::placeholder{color:var(--text-muted)}
        .si{color:var(--text-muted);display:flex}
        table{width:100%;border-collapse:collapse}
        th{padding:10px 20px;text-align:left;font-size:10px;font-weight:500;letter-spacing:1.5px;text-transform:uppercase;color:var(--text-muted);border-bottom:1px solid var(--glass-bd);background:rgba(255,255,255,.015)}
        td{padding:14px 20px;font-size:13px;border-bottom:1px solid rgba(255,255,255,.04);vertical-align:middle}
        tr:last-child td{border-bottom:none}
        tr:hover td{background:rgba(255,255,255,.02)}
        .cav{width:36px;height:36px;border-radius:10px;display:flex;align-items:center;justify-content:center;font-family:'Cormorant Garamond',serif;font-size:16px;font-weight:500;flex-shrink:0}
        .cname{font-size:13.5px;color:var(--text)}
        .csub{font-size:11.5px;color:var(--text-muted);margin-top:2px}
        .badge-status{display:inline-flex;padding:3px 10px;border-radius:20px;font-size:11px;border:1px solid}
        .badge-on{background:rgba(76,175,130,.1);border-color:rgba(76,175,130,.25);color:var(--success)}
        .badge-off{background:rgba(224,90,90,.1);border-color:rgba(224,90,90,.25);color:var(--error)}
        .badge-verified{display:inline-flex;padding:2px 8px;border-radius:6px;font-size:10px;background:rgba(91,155,213,.1);border:1px solid rgba(91,155,213,.2);color:#90c0e8}
        .abtns{display:flex;gap:6px}
        .abtn{width:30px;height:30px;border-radius:8px;background:var(--glass-bg);border:1px solid var(--glass-bd);display:flex;align-items:center;justify-content:center;cursor:pointer;color:var(--text-muted);transition:all .2s}
        ...
        .ph{padding:24px;border-bottom:1px solid var(--glass-bd);display:flex;align-items:center;justify-content:space-between;position:sticky;top:0;background:var(--deep);z-index:1}
        .ph-title{font-family:'Cormorant Garamond',serif;font-size:20px;font-weight:500}
        .ph-close{width:32px;height:32px;border-radius:8px;background:var(--glass-bg);border:1px solid var(--glass-bd);display:flex;align-items:center;justify-content:center;cursor:pointer;color:var(--text-muted);transition:all .2s}
        .ph-close:hover{color:var(--error)}
        .pb{padding:24px;flex:1;display:flex;flex-direction:column;gap:20px}
        .p-av-wrap{display:flex;flex-direction:column;align-items:center;gap:10px;padding:8px 0}
        .p-av{width:72px;height:72px;border-radius:16px;display:flex;align-items:center;justify-content:center;font-family:'Cormorant Garamond',serif;font-size:32px;font-weight:500}
        .p-img{width:72px;height:72px;border-radius:16px;object-fit:cover;border:1px solid var(--glass-bd)}
        ...
        .ds-title{font-size:10px;letter-spacing:2px;text-transform:uppercase;color:var(--gold);opacity:.7;border-bottom:1px solid rgba(201,168,76,.15);padding-bottom:4px}
        .dr{display:flex;justify-content:space-between;align-items:center;padding:6px 0}
        ...
        .panel-actions{display:flex;gap:10px;padding:20px 24px;border-top:1px solid var(--glass-bd)}
        .btn-on{flex:1;padding:10px;border-radius:10px;background:rgba(76,175,130,.1);border:1px solid rgba(76,175,130,.3);color:var(--success);cursor:pointer;font-family:'Outfit',sans-serif;font-size:13px;display:flex;align-items:center;justify-content:center;gap:8px;transition:all .2s}
        .btn-on:hover{background:rgba(76,175,130,.18)}
        .btn-off{flex:1;padding:10px;border-radius:10px;background:rgba(224,90,90,.08);border:1px solid rgba(224,90,90,.25);color:var(--error);cursor:pointer;font-family:'Outfit',sans-serif;font-size:13px;display:flex;align-items:center;justify-content:center;gap:8px;transition:all .2s}
        .btn-off:hover{background:rgba(224,90,90,.15)}
        .btn-del{padding:10px 16px;border-radius:10px;background:rgba(224,90,90,.06);border:1px solid rgba(224,90,90,.2);color:var(--error);cursor:pointer;font-family:'Outfit',sans-serif;font-size:13px;display:flex;align-items:center;gap:6px;transition:all .2s}
        .btn-del:hover{background:rgba(224,90,90,.15)}
        .toast{position:fixed;bottom:28px;right:28px;padding:12px 20px;border-radius:12px;font-size:13px;font-family:'Outfit',sans-serif;z-index:999;animation:slideUp .3s var(--ease-out-expo);border:1px solid}
